...
public class CommissionParametreView extends VerticalLayout implements View, EntityPushListener<Commission> {
	...
	private BeanItemContainer<SimpleTablePresentation> containerGeneral = new BeanItemContainer<>(SimpleTablePresentation.class);
	private BeanItemContainer<SimpleTablePresentation> containerLettre = new BeanItemContainer<>(SimpleTablePresentation.class);
