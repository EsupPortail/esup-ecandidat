...
public class CtrCandCandidatureArchivedView extends CandidatureViewTemplate implements View {
	...
	@PostConstruct
	public void init() {
		super.init(false, ConstanteUtils.TYP_GESTION_CANDIDATURE_CTR_CAND, false, true);
		setTitle("candidature.archived.title");
	}

	@Override
	protected List<Candidature> getListeCandidature(final Commission commission) {
		return candidatureCtrCandController.getCandidatureByCommissionArchived(commission);
	}
