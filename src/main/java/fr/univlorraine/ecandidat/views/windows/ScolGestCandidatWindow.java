...
/**
 * Fenêtre d'édition de mode de gestionnaire de candidat
 * @author Kevin Hergalant
 *
 */
@Configurable(preConstruction=true)
public class ScolGestCandidatWindow extends Window {
	
	/** serialVersionUID **/
	private static final long serialVersionUID = -3344713113859385063L;
	...
	private ChangeGestCandidatWindowListener changeGestCandidatWindowListener;

	/* Composants */
	private CustomBeanFieldGroup<Parametre> fieldGroup;
	...
	/**
	 * Défini le 'ChangeGestCandidatWindowListener' utilisé
	 * @param changeGestCandidatWindowListener
	 */
	public void addChangeGestCandidatWindowListener(ChangeGestCandidatWindowListener changeGestCandidatWindowListener) {
		this.changeGestCandidatWindowListener = changeGestCandidatWindowListener;
	}

	/**
	 * Interface pour récupérer un click sur Oui.
	 */
	public interface ChangeGestCandidatWindowListener extends Serializable {

		/**Appelé lorsque Oui est cliqué.
		 * @param parametre
		 */
		public void btnOkClick(Parametre parametre);
