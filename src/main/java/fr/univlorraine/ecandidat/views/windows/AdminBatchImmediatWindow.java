...
/** 
 * Fenêtre de lancement immédiat d'un batch
 * @author Kevin Hergalant
 *
 */
@Configurable(preConstruction=true)
public class AdminBatchImmediatWindow extends Window {

	/** serialVersionUID **/
	private static final long serialVersionUID = -390485642761186728L;
	...
	/**
	 * Crée une fenêtre de confirmation de lancement avec un message et un titre par défaut
	 */
	public AdminBatchImmediatWindow() {
		this(null, null);
	}

	/**
	 * Crée une fenêtre de confirmation de lancement avec un titre par défaut
	 * @param message
	 */
	public AdminBatchImmediatWindow(String message) {
		this(message, null);
	}
