...
public class CtrCandPostItAddWindow extends Window {
	 ...
	 * @param postIt
	 */
	public CtrCandPostItAddWindow(final PostIt postIt) {
		/* Style */
		setModal(true);
		setClosable(true);
		...
		/* Layout adresse */
		fieldGroup = new CustomBeanFieldGroup<>(PostIt.class, ConstanteUtils.TYP_FORM_CANDIDAT);
		fieldGroup.setItemDataSource(postIt);
		FormLayout formLayout = new FormLayout();
		formLayout.setWidth(100, Unit.PERCENTAGE);
		formLayout.setSpacing(true);
		Field<?> field = fieldGroup.buildAndBind(applicationContext.getMessage("postit.table."
				+ PostIt_.messagePostIt.getName(), null, UI.getCurrent().getLocale()), PostIt_.messagePostIt.getName(), RequiredTextArea.class);
	 ...
	 */
	public void addPostItWindowListener(final PostItWindowListener postItWindowListener) {
