...
public class DroitProfilGestionnaireWindow extends DroitProfilIndividuWindow {
	...
	private OptionGroup selectCommission;
	private Panel panelCommissions;
	...
	public DroitProfilGestionnaireWindow(CentreCandidature ctrCand) {
		...
		comboBoxCGE = new RequiredComboBox<SiScolCentreGestion>(cacheController.getListeCentreGestion(),SiScolCentreGestion.class);
		...
		cbIsAllCommission.addValueChangeListener(e->{
			...
			Boolean modeAllCommission = cbIsAllCommission.getValue();			
		...
		VerticalLayout vlCommissions = new VerticalLayout();
