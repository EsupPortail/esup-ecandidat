...
public class CentreCandidatureController {
	...
	public List<SimpleTablePresentation> getListPresentation(CentreCandidature ctrCand, Boolean readOnly) {
		...
		if (readOnly){
			...
			liste.add(new SimpleTablePresentation(1,CentreCandidature_.temSendMailCtrCand.getName(),applicationContext.getMessage("ctrCand.table." + CentreCandidature_.temSendMailCtrCand.getName(), null, UI.getCurrent().getLocale()), ctrCand.getTemSendMailCtrCand()));
			liste.add(new SimpleTablePresentation(2,CentreCandidature_.mailContactCtrCand.getName(),applicationContext.getMessage("ctrCand.table." + CentreCandidature_.mailContactCtrCand.getName(), null, UI.getCurrent().getLocale()), ctrCand.getMailContactCtrCand()));
			liste.add(new SimpleTablePresentation(3,CentreCandidature_.typeDecisionFav.getName(),applicationContext.getMessage("ctrCand.table." + CentreCandidature_.typeDecisionFav.getName(), null, UI.getCurrent().getLocale()), ctrCand.getTypeDecisionFav()==null?null:ctrCand.getTypeDecisionFav().getLibTypDec()));
			liste.add(new SimpleTablePresentation(4,CentreCandidature_.temListCompCtrCand.getName(),applicationContext.getMessage("ctrCand.table." + CentreCandidature_.temListCompCtrCand.getName(), null, UI.getCurrent().getLocale()), ctrCand.getTemListCompCtrCand()));
			liste.add(new SimpleTablePresentation(5,CentreCandidature_.typeDecisionFavListComp.getName(),applicationContext.getMessage("ctrCand.table." + CentreCandidature_.typeDecisionFavListComp.getName(), null, UI.getCurrent().getLocale()), ctrCand.getTypeDecisionFavListComp()==null?null:ctrCand.getTypeDecisionFavListComp().getLibTypDec()));
			liste.add(new SimpleTablePresentation(6,CentreCandidature_.nbMaxVoeuxCtrCand.getName(),applicationContext.getMessage("ctrCand.table." + CentreCandidature_.nbMaxVoeuxCtrCand.getName(), null, UI.getCurrent().getLocale()),ctrCand.getNbMaxVoeuxCtrCand()+completmentNbVoeuxMaxEtab));
			liste.add(new SimpleTablePresentation(7,CentreCandidature_.temDematCtrCand.getName(),applicationContext.getMessage("ctrCand.table." + CentreCandidature_.temDematCtrCand.getName(), null, UI.getCurrent().getLocale()), ctrCand.getTemDematCtrCand()));
			liste.add(new SimpleTablePresentation(8,CentreCandidature_.datDebDepotCtrCand.getName(),applicationContext.getMessage("ctrCand.table." + CentreCandidature_.datDebDepotCtrCand.getName(), null, UI.getCurrent().getLocale()), (ctrCand.getDatDebDepotCtrCand()==null)?null:formatterDate.format(ctrCand.getDatDebDepotCtrCand())));
			liste.add(new SimpleTablePresentation(9,CentreCandidature_.datFinDepotCtrCand.getName(),applicationContext.getMessage("ctrCand.table." + CentreCandidature_.datFinDepotCtrCand.getName(), null, UI.getCurrent().getLocale()), (ctrCand.getDatFinDepotCtrCand()==null)?null:formatterDate.format(ctrCand.getDatFinDepotCtrCand())));
			liste.add(new SimpleTablePresentation(10,CentreCandidature_.datAnalyseCtrCand.getName(),applicationContext.getMessage("ctrCand.table." + CentreCandidature_.datAnalyseCtrCand.getName(), null, UI.getCurrent().getLocale()), (ctrCand.getDatAnalyseCtrCand()==null)?null:formatterDate.format(ctrCand.getDatAnalyseCtrCand())));			
			liste.add(new SimpleTablePresentation(11,CentreCandidature_.datRetourCtrCand.getName(),applicationContext.getMessage("ctrCand.table." + CentreCandidature_.datRetourCtrCand.getName(), null, UI.getCurrent().getLocale()), (ctrCand.getDatRetourCtrCand()==null)?null:formatterDate.format(ctrCand.getDatRetourCtrCand())));
