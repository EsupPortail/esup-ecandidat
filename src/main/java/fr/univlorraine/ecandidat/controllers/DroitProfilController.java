...
public class DroitProfilController {
	...
	public List<DroitProfilInd> getDroitProfilInds(final Boolean adminMode) {
		...
		if (adminMode) {
			DroitProfil droitProfil =
					new DroitProfil(NomenclatureUtils.DROIT_PROFIL_ADMIN_TECH, NomenclatureUtils.DROIT_PROFIL_ADMIN_TECH, NomenclatureUtils.USER_NOMENCLATURE, NomenclatureUtils.USER_NOMENCLATURE, NomenclatureUtils.TYP_DROIT_PROFIL_ADM, false, true);
	...
	public List<DroitProfil> getListDroitProfilByType(final String type) {
		if (type.equals(NomenclatureUtils.DROIT_PROFIL_ADMIN)) {
			...
			List<DroitProfil> liste = new ArrayList<>();
	...
	public void deleteDroitProfil(final DroitProfil droitProfil) {
		...
		ConfirmWindow confirmWindow = new ConfirmWindow(applicationContext.getMessage("droitprofil.window.confirmDelete", new Object[] {droitProfil.getCodProfil()},
	...
	public void addProfilToUserEnMasse() {
		...
		window.addDroitProfilMasseListener((listGestionnaire, droitProfil) -> {
			ConfirmWindow confirmWindow = new ConfirmWindow(applicationContext.getMessage("droitprofilind.gestcand.window.confirm", new Object[] {droitProfil.getLibProfil(), listGestionnaire.size()},
	...
	public void deleteProfilToUser(final DroitProfilInd droitProfilInd) {
		...
		ConfirmWindow confirmWindow = new ConfirmWindow(applicationContext.getMessage("droitprofilind.window.confirmDelete",
