...
public class TypeDecisionController {
	...
	public List<TypeDecision> getTypeDecisionsEnServiceByCtrCand(final CentreCandidature ctrCand) {
		...
		liste.sort((h1, h2) -> h1.getCodTypDec().compareTo(h2.getCodTypDec()));
		return liste;
	}
	...
	/** @return liste des typeDecisions par centre de candidature */
	public List<TypeDecision> getTypeDecisionsByCtrCand(final Integer idCtrCand) {
		return typeDecisionRepository.findByCentreCandidatureIdCtrCand(idCtrCand);
	}
