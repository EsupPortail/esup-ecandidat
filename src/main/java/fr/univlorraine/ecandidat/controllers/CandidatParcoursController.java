...
public class CandidatParcoursController {
	 ...
	 * @param bac
	 */
	public CandidatBacOuEqu saveBac(CandidatBacOuEqu bac){
	 ...
	 */
	public CandidatCursusPostBac saveCursusPostBac(CandidatCursusPostBac cursus) {
	 ...
	 */
	public CandidatCursusPro saveCursusPro(CandidatCursusPro cursus) {
	 ...
	 * @return le stage
	 */
	public CandidatStage saveStage(CandidatStage stage) {
	 ...
	 */
	public CandidatBacOuEqu getBacByApogeeData(WSBac bacApogee, Candidat candidat, Boolean needToDeleteDataApogee){
		if (bacApogee!=null){
			...
			CandidatBacOuEqu candidatBacOuEqu = new CandidatBacOuEqu(candidat.getIdCandidat(),anneeObt,
					bacOuEqu, commune,dpt, etab, mention, pays, candidat, false);
	 ...
	 */
	public List<CandidatCursusInterne> getCursusInterne(List<WSCursusInterne> listeCursusApogee, Candidat candidat, Boolean needToDeleteDataApogee){
		if (listeCursusApogee!=null && listeCursusApogee.size()>0){
			...
			List<CandidatCursusInterne> liste = new ArrayList<CandidatCursusInterne>();
			listeCursusApogee.forEach(cursus->{
				...
				CandidatCursusInterne cursusInterne = new CandidatCursusInterne(anneeObt,cursus.getCodVet(),cursus.getLibVet(),result,mention,candidat);
