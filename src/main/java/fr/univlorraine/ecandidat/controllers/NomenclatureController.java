...
public class NomenclatureController {
	...
	public void majNomenclature() {
		...
		majParametre(new Parametre(NomenclatureUtils.COD_PARAM_PREFIXE_NUM_DOSS_CPT, applicationContext.getMessage("parametrage.codParam.prefixeNumDossCpt", null, locale), "", NomenclatureUtils.TYP_PARAM_STRING
				+ "(2)"));
		...
		majParametre(new Parametre(NomenclatureUtils.COD_PARAM_GESTION_CANDIDAT_COMM, applicationContext.getMessage("parametrage.codParam.gestionCandidatComm", null, locale), NomenclatureUtils.GEST_CANDIDATURE_READ, NomenclatureUtils.TYP_PARAM_STRING
				+ "(1)"));
		majParametre(new Parametre(NomenclatureUtils.COD_PARAM_GESTION_CANDIDAT_CTR_CAND, applicationContext.getMessage("parametrage.codParam.gestionCandidatCtrCand", null, locale), NomenclatureUtils.GEST_CANDIDATURE_WRITE, NomenclatureUtils.TYP_PARAM_STRING
				+ "(1)"));
	...
	public List<SimpleTablePresentation> getVersions() {
		...
		liste.add(new SimpleTablePresentation(9, NomenclatureUtils.VERSION_INES, applicationContext.getMessage("version.ines", null, UI.getCurrent().getLocale()), "-", null));
		return liste;
	}
	...
	public SimpleTablePresentation getPresentationFromVersion(final Version version, final String code) {
		Integer i = 0;
		String lib = "";
