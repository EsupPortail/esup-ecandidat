...
public class NomenclatureController {
	 ...
	 * @return la version
	 */
	private Version getVersion(String codVersion){
	 ...
	 */
	private Version getDbVersion(String codVersion){
	...
	public void majNomenclature(){
		...
		/*Accès aux actions*/
		majDroitProfilFonc(profilCtrCand, profilCommission,new DroitFonctionnalite(NomenclatureUtils.FONCTIONNALITE_GEST_FENETRE_CAND,applicationContext.getMessage("nomenclature.fonctionnalite.gestFenetreCand.lib", null, locale),applicationContext.getMessage("nomenclature.fonctionnalite.gestFenetreCand.lib", null, locale),true, 7, true));
		majDroitProfilFonc(profilCtrCand, null,new DroitFonctionnalite(NomenclatureUtils.FONCTIONNALITE_GEST_POST_IT,applicationContext.getMessage("nomenclature.fonctionnalite.gestPostIt.lib", null, locale),applicationContext.getMessage("nomenclature.fonctionnalite.gestPostIt.lic", null, locale),true, 8, true));		
		majDroitProfilFonc(profilCtrCand, null,new DroitFonctionnalite(NomenclatureUtils.FONCTIONNALITE_EDIT_TYPTRAIT,applicationContext.getMessage("nomenclature.fonctionnalite.editTypTrait.lib", null, locale),applicationContext.getMessage("nomenclature.fonctionnalite.editTypTrait.lic", null, locale),true,9, true));
		majDroitProfilFonc(profilCtrCand, null,new DroitFonctionnalite(NomenclatureUtils.FONCTIONNALITE_VALID_TYPTRAIT,applicationContext.getMessage("nomenclature.fonctionnalite.validTypTrait.lib", null, locale), applicationContext.getMessage("nomenclature.fonctionnalite.validTypTrait.lic", null, locale),true,10, true));
		majDroitProfilFonc(profilCtrCand, null,new DroitFonctionnalite(NomenclatureUtils.FONCTIONNALITE_EDIT_STATUT_DOSSIER,applicationContext.getMessage("nomenclature.fonctionnalite.editStatutDossier.lib", null, locale),applicationContext.getMessage("nomenclature.fonctionnalite.editStatutDossier.lic", null, locale),true,11, true));
		majDroitProfilFonc(profilCtrCand, null,new DroitFonctionnalite(NomenclatureUtils.FONCTIONNALITE_EDIT_AVIS,applicationContext.getMessage("nomenclature.fonctionnalite.editAvis.lib", null, locale),applicationContext.getMessage("nomenclature.fonctionnalite.editAvis.lic", null, locale),true,12, true));
		majDroitProfilFonc(profilCtrCand, null,new DroitFonctionnalite(NomenclatureUtils.FONCTIONNALITE_VALID_AVIS,applicationContext.getMessage("nomenclature.fonctionnalite.validAvis.lib", null, locale),applicationContext.getMessage("nomenclature.fonctionnalite.validAvis.lic", null, locale),true,13, true));
		...
		/*Messages*/
		majMessage(new Message(NomenclatureUtils.COD_MSG_ACCUEIL,applicationContext.getMessage("nomenclature.message.accueil.lib", null, locale)),applicationContext.getMessage("nomenclature.message.accueil.default", null, locale));
		majMessage(new Message(NomenclatureUtils.COD_MSG_MAINTENANCE,applicationContext.getMessage("nomenclature.message.maintenance.lib", null, locale)),applicationContext.getMessage("nomenclature.message.maintenance.default", null, locale));
		...
		majParametre(new Parametre(NomenclatureUtils.COD_PARAM_IS_UTILISE_OPI_PJ, applicationContext.getMessage("parametrage.codParam.utiliseOpiPj", null, locale), ConstanteUtils.TYP_BOOLEAN_NO,NomenclatureUtils.TYP_PARAM_BOOLEAN));
		...
		majParametre(new Parametre(NomenclatureUtils.COD_PARAM_ALERT_SVA_DAT, applicationContext.getMessage("parametrage.codParam.alertSvaDat", null, locale), NomenclatureUtils.CAND_DAT_NO_DAT, NomenclatureUtils.TYP_PARAM_STRING+"(3)"));
		...
		majParametre(new Parametre(NomenclatureUtils.COD_PARAM_GESTION_CANDIDAT_COMM, applicationContext.getMessage("parametrage.codParam.gestionCandidatComm", null, locale), NomenclatureUtils.GEST_CANDIDATURE_READ, NomenclatureUtils.TYP_PARAM_STRING+"(1)"));
		majParametre(new Parametre(NomenclatureUtils.COD_PARAM_GESTION_CANDIDAT_CTR_CAND, applicationContext.getMessage("parametrage.codParam.gestionCandidatCtrCand", null, locale), NomenclatureUtils.GEST_CANDIDATURE_WRITE, NomenclatureUtils.TYP_PARAM_STRING+"(1)"));
		majParametre(new Parametre(NomenclatureUtils.COD_PARAM_IS_UTILISE_BLOCAGE_AVIS_MASSE, applicationContext.getMessage("parametrage.codParam.utiliseBlocageAvisMasse", null, locale), ConstanteUtils.TYP_BOOLEAN_YES, NomenclatureUtils.TYP_PARAM_BOOLEAN));
	 ...
	 */
	private void majDroitProfilFonc(DroitProfil droitProfilCtrCand, DroitProfil droitProfilCommission, DroitFonctionnalite droitFonctionnalite) {
	 ...
	 * @param typeStatut
	 */
	private void majMessage(Message message, String valDefautMsg){		
	 ...
	 * @param civilite
	 */
	private void majCivilite(Civilite civilite){
	...
	public void cleanNomenclature(){
		...
		if (vNomenclature.isLessThan(new RealeaseVersion(NomenclatureUtils.VERSION_NOMENCLATURE_MAJ_2_2_0_13))){
			...
			listeCampagne.forEach(campagne->{
				if (campagne.getI18nLibCamp()==null){					
					TypeTraduction typeTrad = typeTraductionRepository.saveAndFlush(new TypeTraduction(NomenclatureUtils.TYP_TRAD_CAMP_LIB,applicationContext.getMessage("nomenclature.typtrad.campLib", null, new Locale("fr")),500));
					I18n i18n = i18nRepository.saveAndFlush(new I18n(typeTrad));
		...
		if (vNomenclature.isLessThan(new RealeaseVersion(NomenclatureUtils.VERSION_NOMENCLATURE_MAJ_2_2_5_1))){
			...
			TypeTraduction typeTradForm = typeTraductionRepository.saveAndFlush(new TypeTraduction(NomenclatureUtils.TYP_TRAD_FORM_INFO_COMP,applicationContext.getMessage("nomenclature.typtrad.formInfoComp", null, new Locale("fr")),5000));
			...
			TypeTraduction typeTradComm = typeTraductionRepository.saveAndFlush(new TypeTraduction(NomenclatureUtils.TYP_TRAD_COMM_COMMENT_RETOUR,applicationContext.getMessage("nomenclature.typtrad.commCommentRetour", null, new Locale("fr")),5000));
	 ...
	 * @param newValue
	 */
	private void correctionI18n(I18n i18n, String locale, String oldValue, String newValue){
	...
	public List<SimpleTablePresentation> getVersions(){
		...
		liste.add(new SimpleTablePresentation(1, NomenclatureUtils.VERSION_APPLICATION_COD,applicationContext.getMessage("version.app", null, UI.getCurrent().getLocale()), appVersion, null));
		...
		String wsVersion = MethodUtils.getClassVersion(WSUtils.class);
		liste.add(new SimpleTablePresentation(5,NomenclatureUtils.VERSION_WS,applicationContext.getMessage("version.ws", null, UI.getCurrent().getLocale()), wsVersion,null));
		liste.add(new SimpleTablePresentation(6,NomenclatureUtils.VERSION_WS_PJ,applicationContext.getMessage("version.ws.pj", null, UI.getCurrent().getLocale()), wsVersion,null));
		...
		liste.add(new SimpleTablePresentation(7,NomenclatureUtils.VERSION_DEMAT,applicationContext.getMessage("version.demat", null, UI.getCurrent().getLocale()),libDemat,null));
		liste.add(new SimpleTablePresentation(8,NomenclatureUtils.VERSION_LS,applicationContext.getMessage("version.limesurvey", null, UI.getCurrent().getLocale()),"-",null));
