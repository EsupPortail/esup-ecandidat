...
public class MailController {
	 ...
	 */
	private Mail getMailByCod(String code) {
	 ...
	 */
	public CandidatMailBean getCandidatMailBean(Candidat candidat, String locale){
	 ...
	 */
	private CandidatureMailBean getCandidatureMailBean(Candidature candidature, String locale){
	 ...
	 * @param attachement 
	 */
	private void sendMail(String mailTo, String title, String text, String bcc, PdfAttachement attachement) {
		try {
	 ...
	 * @param bean
	 */
	public void sendMailByCod(String mailAdr, String cod, MailBean bean, Candidature candidature, String locale) {
		Mail mail = getMailByCod(cod);
	 ...
	 * Envoie un mail
	 */
	public void sendMail(String mailAdr, Mail mail, MailBean bean, Candidature candidature, String locale, PdfAttachement attachement){
	 ...
	 */
	private String parseVar(String contentMail, String var, MailBean bean){
	...
	public String getVarMailCandidature(String codMail){
		if (codMail!=null && (codMail.equals(NomenclatureUtils.MAIL_CPT_MIN) || 
			...
			return NomenclatureUtils.MAIL_GEN_VAR+";"+NomenclatureUtils.MAIL_CANDIDAT_GEN_VAR+";"+NomenclatureUtils.MAIL_FORMATION_GEN_VAR+";"+NomenclatureUtils.MAIL_COMMISSION_GEN_VAR+";"+NomenclatureUtils.MAIL_DOSSIER_GEN_VAR;
		}
	}
	 ...
	 * @param loggers
	 */
	public void sendErrorToAdminFonctionnel(String title, String text, Logger loggers){
