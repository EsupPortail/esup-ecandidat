...
public class Configuration implements Serializable {
	...
	public final static String COD_CONFIG_ETAB_STATIC_LOGO = "LOGO";
	public final static String COD_CONFIG_ETAB_STATIC_FAVICON = "FAVICON";
	public final static String COD_CONFIG_ETAB_STATIC_MESSAGE = "MESSAGE";
	public final static String COD_CONFIG_ETAB_STATIC_MESSAGE_EN = "MESSAGE_EN";
	public final static String COD_CONFIG_ETAB_STATIC_TEMPLATE_DOSSIER = "TEMPLATE_DOSSIER";
	public final static String COD_CONFIG_ETAB_STATIC_TEMPLATE_LETTRE_ADM = "TEMPLATE_LETTRE_ADM";
	public final static String COD_CONFIG_ETAB_STATIC_TEMPLATE_LETTRE_REFUS = "TEMPLATE_LETTRE_REFUS";
	public final static String COD_CONFIG_ETAB_STATIC_SISCOL_CONFIG_APO = "SISCOL_CONFIG_APO";
