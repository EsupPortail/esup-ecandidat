...
@Table(name="batch")
@Data @EqualsAndHashCode(of="codBatch")
...
public class Batch implements Serializable {
	...
	public Batch(String codBatch, String libBatch,
			Boolean temIsLaunchImediaBatch, Boolean tesBatch, Integer hour, Integer min) {
		super();
	...
	public Batch(String codBatch, String libBatch,
			Boolean temIsLaunchImediaBatch, Boolean tesBatch,
			Boolean temLundiBatch,Boolean temMardiBatch,Boolean temMercrBatch,Boolean temJeudiBatch,
			Boolean temVendrediBatch,Boolean temSamediBatch,Boolean temDimanBatch, Integer hour, Integer min) {
		super();
		this.codBatch = codBatch;
		this.libBatch = libBatch;
		this.temIsLaunchImediaBatch = temIsLaunchImediaBatch;
