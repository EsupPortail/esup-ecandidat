...
public class DroitProfil implements Serializable {
	...
	public DroitProfil(final String user) {
		this();
		this.userCreProfil = user;
		this.userModProfil = user;
	}

	public DroitProfil(final String codProfil, final String libProfil,
			final String userCreProfil, final String userModProfil, final String typProfil,
			final Boolean temUpdatable, final Boolean tesProfil) {
		super();
	 ...
	 */
	public void addFonctionnalite(final DroitProfilFonc droitProfilFonc) {
		if (new ArrayList<>(this.droitProfilFoncs).stream().filter(s -> s.getId().equals(droitProfilFonc.getId())).findFirst() != null) {
