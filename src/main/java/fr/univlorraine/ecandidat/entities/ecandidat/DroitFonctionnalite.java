...
public class DroitFonctionnalite implements Serializable {
	...
	public DroitFonctionnalite(String codFonc, String libFonc, String licFonc, Boolean temOpenComFonc, Integer orderFonc, Boolean temActionCandFonc) {
		super();
	...
	public DroitFonctionnalite(String codFonc, String libFonc, Boolean temOpenComFonc, Integer orderFonc, Boolean temActionCandFonc) {
		super();
		this.codFonc = codFonc;
		this.libFonc = libFonc;
		this.temOpenComFonc = temOpenComFonc;
	...
	public DroitFonctionnalite(String codFonc, String libFonc, Integer orderFonc, Boolean temActionCandFonc) {
		super();
		this.codFonc = codFonc;
		this.libFonc = libFonc;
	...
	public DroitFonctionnalite(DroitFonctionnalite df, Boolean readOnly){
		super();
