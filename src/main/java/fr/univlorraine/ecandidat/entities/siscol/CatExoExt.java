 ...
 */
@Entity
@Table(name = "CAT_EXO_EXT")
@Data
@EqualsAndHashCode(of = "codCatExoExt")
@SuppressWarnings("serial")
public class CatExoExt implements Serializable {
	...
	@Column(name = "TEM_EN_SVE_CAT_EXO_EXT", nullable = false, length = 1)
	@Size(max = 1)
	@NotNull
	private String temEnSveCatExoExt;
