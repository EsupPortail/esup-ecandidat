...
/**
 * Champs de rich text area customisé
 * @author Kevin Hergalant
 */
@SuppressWarnings("serial")
public class RequiredRichTextArea extends RichTextArea implements IRequiredField {
	...
	public RequiredRichTextArea(final String defaultCharset) {
		super();
