...
public class I18nField extends CustomField<I18n> implements IRequiredField{
	 ...
	 */
	@Override
	protected void setInternalValue(I18n newFieldValue){
		super.setInternalValue(newFieldValue);
		valeur = newFieldValue.clone();
		typeTraduction = valeur.getTypeTraduction();
		listeTraduction = new ArrayList<I18nTraduction>(valeur.getI18nTraductions());
	}
	...
	private List<I18nTraduction> getValueField(I18n i18n){
		List<I18nTraduction> listeToRet = new ArrayList<I18nTraduction>();
