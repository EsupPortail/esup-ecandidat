...
public class FileManagerCmisImpl implements FileManager {
	...
	public FileManagerCmisImpl(String user, String password, String url, String repository, String idFolderGestionnaire,
			String idFolderCandidat, Boolean enableVersioningCmis) {
		super();
		this.user = user;
	 ...
	 * @throws FileException
	 */
	public Folder getFolderCandidature(Candidature candidature, Boolean isPjCommune) throws FileException {
		try {
