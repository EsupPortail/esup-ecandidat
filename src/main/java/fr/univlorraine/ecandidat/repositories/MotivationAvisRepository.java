...
public interface MotivationAvisRepository extends JpaRepository<MotivationAvis, Integer> {
	...
	MotivationAvis findByCodMotiv(String cod);

	List<MotivationAvis> findByTesMotivAndCentreCandidatureIdCtrCand(Boolean tes, Integer idCtrCand);

	Long countByCentreCandidature(CentreCandidature centreCandidature);

	List<MotivationAvis> findByCentreCandidatureIdCtrCand(Integer idCtrCand);
}
