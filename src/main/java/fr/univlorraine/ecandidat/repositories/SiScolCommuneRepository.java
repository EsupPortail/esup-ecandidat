...
public interface SiScolCommuneRepository extends JpaRepository<SiScolCommune, SiScolCommunePK> {
	...
	@Query("select distinct c from SiScolCommune c, SiScolEtablissement etab where c.siScolDepartement.id.typSiScol = :typSiScol and c.siScolDepartement.id.codDep = :codDep and etab.siScolDepartement.id.typSiScol = :typSiScol and etab.siScolDepartement.id.codDep = :codDep and etab.siScolCommune.id.typSiScol = :typSiScol and etab.siScolCommune.id.codCom = c.id.codCom ")
