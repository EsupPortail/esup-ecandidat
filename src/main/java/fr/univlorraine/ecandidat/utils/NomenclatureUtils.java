...
public class NomenclatureUtils {
	...
	public static final String VERSION_NOMENCLATURE_VAL = "2.2.8.1";
	...
	public static final String COD_PARAM_IS_SERVICE_FICHIER_MAINTENANCE = "IS_SERVICE_FICHIER_MAINTENANCE";
