...
public class NomenclatureUtils {
	...
	public static final String VERSION_NOMENCLATURE_VAL = "2.3.1.1";
	...
	public static final String MAIL_DOSSIER_GEN_VAR = "dossier.dateReception;dossier.montantFraisIns";
